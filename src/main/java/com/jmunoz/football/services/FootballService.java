package com.jmunoz.football.services;
...
// Esta clase gestiona la data en un Map, manteniendo todos los jugadores en memoria.
@Service
public class FootballService {
    ...
    public void deletePlayer(String id) {
        // Si player no existe, continúa sin errores.
        players.remove(id);
    }
}
